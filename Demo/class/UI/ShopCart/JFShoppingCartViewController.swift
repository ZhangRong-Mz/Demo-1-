...
class JFShoppingCartViewController: UIViewController{
    ...
    private func prepareUI() {
        var shopCart2=UIStoryboard(name: "Home", bundle: nil).instantiateViewControllerWithIdentifier("shopCartViewController2") as UIViewController
        var shopCart22=UIStoryboard(name: "Home", bundle: nil).instantiateViewControllerWithIdentifier("shopCartViewController2Empty") as UIViewController
        var isEmpty=false
            if !isEmpty{
        
                self.navigationController?.pushViewController(shopCart2, animated: true)
                self.navigationController?.navigationBarHidden=true
            }
            else{
                self.navigationController?.pushViewController(shopCart22, animated: true)
                self.navigationController?.navigationBarHidden=true
            }
    ...
    private func prepareUI2() {
        var shopCart1=UIStoryboard(name: "Home", bundle: nil).instantiateViewControllerWithIdentifier("shopCartViewController1") as UIViewController
        var shopCart11=UIStoryboard(name: "Home", bundle: nil).instantiateViewControllerWithIdentifier("shopCartViewController1Empty") as UIViewController
        var isEmpty=false
        if !isEmpty{
            
            self.navigationController?.pushViewController(shopCart1, animated: true)
            self.navigationController?.navigationBarHidden=true
        }
        else{
            self.navigationController?.pushViewController(shopCart11, animated: true)
            self.navigationController?.navigationBarHidden=true
        }
