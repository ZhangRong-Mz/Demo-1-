...
@IBDesignable public class GMStepper: UIControl {
    ...
    @IBInspectable public var buttonsBackgroundColor: UIColor = UIColor(red:1, green:1, blue:1, alpha:1) {
        didSet {
            for button in [leftButton, rightButton] {
    ...
    @IBInspectable public var labelBackgroundColor: UIColor = UIColor(red:1, green:1, blue:1, alpha:1) {
        didSet {
